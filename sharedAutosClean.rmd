...
```{r analysis-availability-detail-utilize, fig.align = 'center', fig.width = 8, fig.height = 4}
...
We will now develop a similar model, expanding our data to a full week of samples. We also add a calculation for the day of week efects to see how significant that might be. 
...
of the day factor does not significantly improve the prediction result, but by adding
in information about the location significantly improves our result.
